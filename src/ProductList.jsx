...
function ProductList({ onHomeClick }) {
    ...
    const isPlantAdded = (plantName) => {
        return cart.find(plant => plant.name === plantName) !== undefined;
    }
    return (
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><div className="cart_quantity_count"> {countNumberOfItems()} </div></a>
